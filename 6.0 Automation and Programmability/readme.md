...
- <a name="_hlk186043248"></a>[ User ] <--- NBI --->[ Controller ]< ----- SBI ---->[ Devices ]
...
- REST APIs use various authentication mechanisms to secure endpoints and validate users:
  ...
  - Bearer Token Authentication: 
    - Uses tokens (e.g., OAuth 2.0 tokens) for authorization, included in the Authorization header as Bearer <token>.
  - API Keys: 
